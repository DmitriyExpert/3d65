...
$title = 'Пользователь ' .$name. ' задет вопрос.'; // Название письма
$body = '<p>Имя: <strong>'.$name.'</strong></p>'.
         '<p>Почта: <strong>'.$email.'</strong></p>'. 
         '<p>Вопрос: <strong>'.$comment.'</strong></p>';
// Настройки PHPMailer
...
try {
  ...
  $mail->setFrom('dpemvr@yandex.ru', 'Вопрос с сайта 3d65'); // Адрес самой почты и имя отправителя
